 ...
 * @method static array submitIntent(string $streamId, string $entityId, string $intentType, array $payload, ?string $intentId = null)
 * @method static array intent(string $streamId, string $entityId, string $intentType, array $payload, ?string $intentId = null)
 * @method static void intentStream(string $streamId, string $entityId, string $intentType, array $payload, callable $onEvent, ?string $intentId = null)
